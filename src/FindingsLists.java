...
public class FindingsLists {
    public FindingsLists() throws InterruptedException
    {
        ...
        ArrayList rockList = new ArrayList(4);
        ...
        System.out.println("Which of the fossils would you like to learn more about (Spelling and Spacing is important)? " + fossilDirectory.keySet().toString());
